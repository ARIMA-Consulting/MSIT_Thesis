...
#TestStartDate <- as.Date("2020-04-01")
#TestEndDate <- as.Date("2020-04-30")
#TestDateRange <- c(seq(TestStartDate, TestEndDate, by = "day"))
#rownames(forecastAutoARIMA) <- TestDateRange
#forecastAutoARIMA$Date <- TestDateRange
#forecastAutoARIMA <- data.frame(forecastAutoARIMA)
